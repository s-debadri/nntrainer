...
auto semantic_multi_head_attention_gpu = LayerSemanticsParamType(
  nntrainer::createLayer<nntrainer::CustomMultiHeadAttentionLayerCl>,
  nntrainer::CustomMultiHeadAttentionLayerCl::type,
  {"num_heads=1", "projected_key_dim=1", "max_timestep=1"},
  LayerCreateSetPropertyOptions::AVAILABLE_FROM_APP_CONTEXT, false, 3);

auto semantic_multi_head_attention_with_mask_gpu = LayerSemanticsParamType(
  nntrainer::createLayer<nntrainer::CustomMultiHeadAttentionLayerCl>,
  nntrainer::CustomMultiHeadAttentionLayerCl::type,
  {"num_heads=1", "projected_key_dim=1", "max_timestep=1"},
...
GTEST_PARAMETER_TEST(
  MultiHeadAttentionGpu, LayerSemanticsGpu,
  ::testing::Values(semantic_multi_head_attention_gpu,
                    semantic_multi_head_attention_with_mask_gpu));

auto no_cos_sim_option_gpu = LayerGoldenTestParamOptions::SKIP_COSINE_SIMILARITY;
auto inference_only_option_gpu =
  LayerGoldenTestParamOptions::SKIP_COSINE_SIMILARITY |
  LayerGoldenTestParamOptions::SKIP_CALC_DERIV |
  LayerGoldenTestParamOptions::SKIP_CALC_GRAD |
  LayerGoldenTestParamOptions::USE_INC_FORWARD;

auto multi_head_attention_single_batch_gpu = LayerGoldenTestParamType(
  nntrainer::createLayer<nntrainer::CustomMultiHeadAttentionLayerCl>,
  {"num_heads=12", "projected_key_dim=64", "max_timestep=1024",
   "smart_reply=false"},
  "1:1:1024:768,1:1:1024:768,1:1:1024:768",
  "custom_multi_head_attention_single_batch.nnlayergolden",
  inference_only_option_gpu, "nchw", "fp32", "fp32");
...
//   "2:1:5:7,2:1:3:7,2:1:3:7",
//   "multi_head_attention_output_shape.nnlayergolden", no_cos_sim_option,
//   "nchw", "fp32", "fp32");
...
GTEST_PARAMETER_TEST(MultiHeadAttentionGpu, LayerGoldenTest,
                     ::testing::Values(multi_head_attention_single_batch_gpu));
...
//   {"num_heads=2", "projected_key_dim=3", "projected_value_dim=5"},
//   "2:1:5:7,2:1:3:7,2:1:3:7",
//   "multi_head_attention_value_dim_w16a16.nnlayergolden",
//   inference_only_option, "nchw", "fp16", "fp16");
